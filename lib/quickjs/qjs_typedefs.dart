...
import 'package:flutter_qjs_es2023/quickjs/utf8_null_terminated.dart';
...
// ignore: camel_case_types
typedef JS_GetNullValue =
    Pointer Function(Pointer<JSContext> ctx, Pointer<JSValueConst> v);

typedef JSEvalWrapperNative =
    Pointer Function(
      Pointer<JSContext> ctx,
      Pointer<Utf8NullTerminated> input,
      Int32 inputLength,
